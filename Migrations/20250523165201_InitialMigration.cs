    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorPayrolls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorPayrolls_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaffPayrolls_Staff_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsuranceCoverage = table.Column<decimal>(type: "decimal(5,4)", precision: 5, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tests_MedicalRecords_MedicalRecordId",
                        column: x => x.MedicalRecordId,
                        principalTable: "MedicalRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tests_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorPayrolls_DoctorId",
                table: "DoctorPayrolls",
                column: "DoctorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffPayrolls_StaffId",
                table: "StaffPayrolls",
                column: "StaffId");

            migrationBuilder.CreateIndex(
                name: "IX_Tests_MedicalRecordId",
                table: "Tests",
                column: "MedicalRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_Tests_ServiceId",
                table: "Tests",
                column: "ServiceId");
        }
